...
<head>
    <meta charset="utf-8" />
    <title>Magnet :: Cash / Bank Entry</title>
            ...
            <div class="page-content">
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        <li>
                            <span>Cash / Bank Entry</span>
                        </li>
                    </ul>
                    <div class="page-toolbar">
                        <div class="btn-group pull-right">
                            <button type="button" class="btn btn-sm editcompany" >
                                <a href="cash_bank_entry_records.php">View Records</a>
                            </button>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3 pb-15">
                                                        <div class="form-group form-md-line-input margin-zero">
                                                            ...
                                                            <label class="control-label margin-zero font-light">Cash / Bank : </label>
                                                        </div>
                                                    </div>
				...
				<div class="col-md-3 pb-15">
                                                        <div class="form-group form-md-line-input margin-zero">
                                                            ...
                                                            <label class="control-label margin-zero font-light">Payment / Receipt : </label>
                                                        </div>
                                                    </div>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $('#addlines').click(function () {
                    ...
                    var tablerow = '<tr><td contenteditable="true" class="counterCell"></td><td contenteditable="true"></td><td><a href="javascript:;"><img src="image/delete.png" /></a></td></tr>';
