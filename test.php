                        ...
                        <div class="portlet light companydiv" style="border-bottom: 2px solid #418bca;">
                            ...
                            <div class="portlet-title" style="border-bottom: 0px;margin-bottom: 0px;">
                                <div class="caption caption-md">
                                    ...
                                    <span class="caption-subject bold compheading">Filter Information : </span>
                                </div>
                            </div>
                                        ...
                                        <div class="row">
                                                    ...
                                                    <div class="col-md-4 pb-15">
                                                        <div class="form-group form-md-line-input margin-zero">
                                                            <select class="form-control font-bold" id="form_control_1">
                                                                <option value="2" selected="">All Dates</option>
                                                                <option value="3">Today</option>
                                                                <option value="4">This week</option>
                                                                <option value="4">This month</option>
                                                                <option value="4">This quarter</option>
                                                                <option value="4">This financial year</option>
                                                                <option value="4">Last week</option>
                                                                <option value="4">Last month</option>
                                                                <option value="4">Last quarter</option>
                                                                <option value="4">Last financial year</option>
                                                                <option value="4">Custom Date</option>
                                                            </select>
                                                            <label class="control-label margin-zero font-light">Period Filter : </label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 pb-15">
                                                        <div class="form-group form-md-line-input margin-zero">
                                                            <select class="form-control font-bold" id="form_control_1">
                                                                ...
                                                                <option value="2">Greater than or equals to</option>
                                                                <option value="3">Less than</option>
                                                                <option value="2">Less than or equals to</option>
                                                                <option value="4">Between</option>
                                                                <option value="4">Equals</option>
                                                                <option value="4">Does not equals</option>
                                                            ...
                                                            <label class="control-label margin-zero font-light">Number Filter : </label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 pb-15">
                                                        <div class="form-group form-md-line-input margin-zero">
                                                            <select class="form-control font-bold" id="form_control_1">
                                                                ...
                                                                <option value="2">Hundred</option>
                                                                <option value="3">Thousand</option>
                                                                <option value="4">Then thousand</option>
                                                                <option value="3">Lacs</option>
                                                                <option value="3">Ten Lacs (Million)</option>
                                                                <option value="3">Crore</option>
                                                                <option value="3">Ten crore</option>
                                                                <option value="3">Hundred crore (Billion)</option>
                                                            </select>
                                                            <label class="control-label margin-zero font-light">Scale factor for value : </label>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-7 col-md-offset-5 pb-15">
                                                    <div class="form-group margin-zero">
                                                        <button type="submit" class="btn blue bold addaccountcolor" style="min-width:130px;font-size:17px">Generate Report</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>                                                    
