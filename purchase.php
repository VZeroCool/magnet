                    ...
                    <div class="page-toolbar">
                        <div class="btn-group pull-right">
                            <button type="button" class="btn btn-sm editcompany">
                                <a href="purchase_records.php">View Records</a>
                            </button>
                        </div>
                    </div>
                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 pb-15">
                                                        <div class="form-group form-md-line-input margin-zero">
                                                            ...
                                                            <label class="control-label margin-zero font-light">Balance : </label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3 pb-15">
                                                        <div class="form-group form-md-line-input margin-zero">
                                                            <select class="form-control padding-zero font-bold" id="form_control_1">
                                                                <option value="1" selected="">Select PO Number</option>
                                                                <option value="2">Option 2</option>
                                                                <option value="3">Option 3</option>
                                                                <option value="4">Option 4</option>
                                                            </select>
