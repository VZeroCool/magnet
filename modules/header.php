<!-- BEGIN HEADER -->
    <div class="page-header navbar navbar-fixed-top">
        ...
        <div class="page-header-inner ">
            ...
            <!-- END LOGO -->
            <form class="search-form search-form-expanded header-color" action="page_general_search_2.html" method="GET">
                <div class="input-icon right">
                    <i class="icon-magnifier"></i>
                    <input type="text" class="form-control radius-border searchbar" placeholder="  Search ... ">
                </div>
            </form>
            ...
            <div class="top-menu">
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown dropdown-user">
                        <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                            <img alt="" class="img-circle" src="image/avatar3_small.jpg" />
                            <span class="username username-hide-on-mobile"> Magnet Accounting PVT LTD </span>
