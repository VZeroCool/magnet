        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                    ...
                    <div class="page-toolbar">
                        <div class="btn-group pull-right">
                            <button type="button" class="btn btn-sm editcompany" >
                                <a href="sales_records.php">View Records</a>
                            </button>
                        </div>
                    </div>
                </div>
                ...
                <div class="row" style="margin-top:20px">
                    <div class="col-md-12">
                        <div class="topselection" style="border-bottom: 2px solid #418bca;">
                            <div class="md-radio-inline">
                                <a href="javascript:;" class="md-radio">
                                    <input type="radio" id="radio1" name="radio2" data-target="#tab_1_1" class="md-radiobtn"data-toggle="tab">
                                    <label for="radio1" class="active">
                                        <span></span>
                                        <span class="check"></span>
                                        <span class="box font-bold"></span> Tax Invoice
                                    </label>
                                </a>
                                <a href="javascript:;" class="md-radio">
                                    <input type="radio" id="radio2" name="radio2" data-target="#tab_1_2" class="md-radiobtn" data-toggle="tab">
                                    <label for="radio2">
                                        <span></span>
                                        <span class="check"></span>
                                        <span class="box font-bold"></span> Delivery challan
                                    </label>
                                </a>
                                <a href="javascript:;" class="md-radio">
                                    <input type="radio" id="radio3" name="radio2" data-target="#tab_1_3"  class="md-radiobtn" data-toggle="tab">
                                    <label for="radio3">
                                        <span></span>
                                        <span class="check"></span>
                                        <span class="box font-bold"></span> Estimate
                                    </label>
                                </a>
                                <a href="javascript:;" class="md-radio">
                                    <input type="radio" id="radio4" name="radio2" data-target="#tab_1_4"  class="md-radiobtn" data-toggle="tab">
                                    <label for="radio4">
                                        <span></span>
                                        <span class="check"></span>
                                        <span class="box font-bold"></span> Proforma Invoice
                                    </label>
                                </a>
                                <a href="javascript:;" class="md-radio">
                                    <input type="radio" id="radio5" name="radio2" data-target="#tab_1_5"  class="md-radiobtn" data-toggle="tab">
                                    <label for="radio5">
                                        <span></span>
                                        <span class="check"></span>
                                        <span class="box font-bold"></span> Cash Memo
                                    </label>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="portlet light companydiv" style="border-bottom: 2px solid #418bca;">
                            <div class="portlet-title" style="border-bottom: 0px;margin-bottom: 0px;">
                                <div class="caption caption-md">
                                    ...
                                    <span class="caption-subject bold compheading">Customer Information : </span>
                                </div>
                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-2 pb-15">
                                                        <div class="form-group form-md-line-input margin-zero">
                                                            <input id="form_control_1" type="text" placeholder="MAPL/001" class="form-control padding-zero font-bold" disabled="disabled">
                                                            <label class="control-label margin-zero font-light">Invoice Number : </label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 pb-15">
                                                        <div class="form-group form-md-line-input margin-zero">
                                                            <input id="form_control_1" type="text" placeholder="Enter Customer Name" class="form-control padding-zero font-bold">
                                                            <label class="control-label margin-zero font-light">Customer Name : </label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2 pb-15">
                                                        <div class="form-group form-md-line-input margin-zero">
                                                            ...
                                                            <label class="control-label margin-zero font-light">Invoice Date : </label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 pb-15">
                                                        <div class="form-group form-md-line-input margin-zero">
                                                            <input type="text" placeholder="" class="form-control padding-zero font-bold" value="500000">
                                                            <label class="control-label margin-zero font-light">Balance Due : </label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 pb-15">
                                                        <div class="form-group form-md-line-input margin-zero">
                                                            <input type="text" placeholder="Enter Billing Address" class="form-control padding-zero font-bold">
                                                            <label class="control-label margin-zero font-light">Billing Address : </label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 pb-15">
                                                        <div class="form-group form-md-line-input margin-zero">
                                                            <input type="text" placeholder="Enter Shipping Address" class="form-control padding-zero font-bold">
                                                            <label class="control-label margin-zero font-light">Shipping Address : </label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3 pb-15">
                                                        <div class="form-group form-md-line-input margin-zero">
                                                            <input type="text" placeholder="Enter Place of Supply" class="form-control padding-zero font-bold">
                                                    ...
                                                    <div class="col-md-3 pb-15">
                                                        <div class="form-group form-md-line-input margin-zero">
                                                            ...
                                                            <label class="control-label margin-zero font-light">Terms : </label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3 pb-15">
                                                        <div class="form-group form-md-line-input margin-zero">
                                                            <input type="text" placeholder="(dd/mm/yyyy)" data-date-format="dd-mm-yyyy" class="form-control form-control-inline date-picker padding-zero font-bold" size="16">
                                                            <label class="control-label margin-zero font-light">Due Date : </label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3 pb-15">
                                                        <div class="form-group form-md-line-input margin-zero">
                                                            <input type="text" placeholder="Enter DC Number" class="form-control padding-zero font-bold">
                                                            <label class="control-label margin-zero font-light">DC Number : </label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3 pb-15">
                                                        <div class="form-group form-md-line-input margin-zero pull-right">
                                                            <label class="control-label margin-zero font-light">
                                                    ...
                                                    <div class="col-md-1 pb-15">
                                                        <div class="form-group form-md-line-input margin-zero">
                                                            <input type="text" placeholder="Code" value="91" class="form-control padding-zero font-bold" disabled="disabled">
                                            ...
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="col-md-2 pb-15">
                                                        <div class="form-group form-md-line-input margin-zero">
                                                            <input id="form_control_1" type="text" placeholder="MAPL/001" class="form-control padding-zero font-bold" disabled="disabled">
                                                            <label class="control-label margin-zero font-light">Challan Number : </label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 pb-15">
                                                        <div class="form-group form-md-line-input margin-zero">
                                                    ...
                                                    <div class="col-md-2 pb-15">
                                                        <div class="form-group form-md-line-input margin-zero">
                                                            <input type="text" placeholder="(dd/mm/yyyy)" data-date-format="dd-mm-yyyy" class="form-control form-control-inline date-picker padding-zero font-bold" size="16">
                                                            <label class="control-label margin-zero font-light">Challan Date : </label>
                                                        </div>
                                                    </div>
                                                     <div class="col-md-4 pb-15">
                                                        <div class="form-group form-md-line-input margin-zero">
                                                            <input type="text" placeholder="Mode of transportaion"class="form-control form-control-inline padding-zero font-bold">
                                                            <label class="control-label margin-zero font-light">Mode of transportaion : </label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 pb-15">
                                                        <div class="form-group form-md-line-input margin-zero">
                                                    ...
                                                    <div class="col-md-2 pb-15">
                                                        <div class="form-group form-md-line-input margin-zero">
                                                            <input type="text" placeholder="Vehical Number" class="form-control padding-zero font-bold">
                                                            <label class="control-label margin-zero font-light">Vehical Number :</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3 pb-15">
                                                        <div class="form-group form-md-line-input margin-zero">
                                                            <input type="text" placeholder="(dd/mm/yyyy)" data-date-format="dd-mm-yyyy" class="form-control form-control-inline date-picker padding-zero font-bold" size="16">
                                                            <label class="control-label margin-zero font-light">Date: </label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="col-md-2 pb-15">
                                                        <div class="form-group form-md-line-input margin-zero">
                                                            <input id="form_control_1" type="text" placeholder="Estimate" class="form-control padding-zero font-bold" disabled="disabled">
                                                            <label class="control-label margin-zero font-light">Estimate : </label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 pb-15">
                                                        <div class="form-group form-md-line-input margin-zero">
                                            ...
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="col-md-2 pb-15">
                                                        <div class="form-group form-md-line-input margin-zero">
                                                            <input id="form_control_1" type="text" placeholder="MAPL/001" class="form-control padding-zero font-bold" disabled="disabled">
                                                            <label class="control-label margin-zero font-light">Sr Number : </label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 pb-15">
                                                        <div class="form-group form-md-line-input margin-zero">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <textarea id="linenumber" placeholder="Terms and Conditions on invoice" rows="5" class="form-control padding-zero font-bold"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <textarea id="linenumber" placeholder="Bank Detail" rows="5" class="form-control padding-zero font-bold"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="portlet-body form">
                                    <div class="form-horizontal pr-15">
                                        <div class="form-body padding-zero">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-8">
                                                    <label class="control-label  pull-right">Insurance : </label>
                                                </div>
                                                <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-8">
                                                    <label class="control-label  pull-right">Packing & Forwarding Charges : </label>
                                                </div>
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control" />
                                                </div>
