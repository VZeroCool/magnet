...
<head>
    <meta charset="utf-8" />
    <title>Magnet :: Debit Note / Credit Note</title>
            ...
            <div class="page-content">
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        <li>
                            <span>Debit Note / Credit Note</span>
                        </li>
                    </ul>
                    <div class="page-toolbar">
                        <div class="btn-group pull-right">
                            <button type="button" class="btn btn-sm editcompany">
                                <a href="debit_credit_note_records.php">View Records</a>
                            </button>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="md-radio-inline">
                                <a href="javascript:;" class="md-radio">
                                    ...
                                    <label for="radio1" class="active">
                                        ...
                                        <span class="box font-bold"></span> Credit Note
                                    </label>
                                </a>
                                <a href="javascript:;" class="md-radio">
                                    ...
                                    <label for="radio2">
                                        <span></span>
                                        <span class="check"></span>
                                        <span class="box font-bold"></span> Debit Note
                                    </label>
                                </a>
                            </div>
                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3 pb-15">
                                                        <div class="form-group form-md-line-input margin-zero">
                                                            ...
                                                            <label class="control-label margin-zero font-light">Credit Note Number : </label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3 pb-15">
                                                        <div class="form-group form-md-line-input margin-zero">
                                                    ...
                                                    <div class="col-md-3 pb-15">
                                                        <div class="form-group form-md-line-input margin-zero">
                                                            <input id="form_control_1" type="text" placeholder="MAPL/001" class="form-control padding-zero font-bold" >
                                                            <label class="control-label margin-zero font-light">Origional Invoice Number : </label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3 pb-15">
                                                        <div class="form-group form-md-line-input margin-zero">
                                            ...
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="col-md-3 pb-15">
                                                        <div class="form-group form-md-line-input margin-zero">
                                                            <input id="form_control_1" type="text" placeholder="MAPL/001" class="form-control padding-zero font-bold" >
                                                            <label class="control-label margin-zero font-light">Debit Note Number : </label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3 pb-15">
                                                        <div class="form-group form-md-line-input margin-zero">
