...
<head>
    <meta charset="utf-8" />
    <title>Magnet :: Employee Detail</title>
...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid page-content-white">
            ...
            <div class="page-content">
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        <li>
                            <span style="color: white;">Employee Master</span>
                        </li>
                    </ul>
                </div>
                <!-- END PAGE BAR -->
                        ...
                        <div class="portlet box">
                            <div class="portlet-title blackcolor filter_heading-radius p-r-0">
                                ...
                                <div class="actions" style="padding:0px">
                                    <div class="btn-group">
                                        <button id="sample_editable_1_new" class="btn green addaccountcolor" href="#employeemaster" data-toggle="modal">
                                            <a>ADD EMPLOYEE</a>
    ...
    <!-- full width -->
    <div id="employeemaster" class="modal container fade" tabindex="-1">
                ...
                <div class="col-md-12">
                    <div class="portlet light companydiv bordernone margin-zero">
                                            ...
                                            <div class="row">
                                                <div class="col-md-3 pb-15">
                                                    <div class="form-group form-md-line-input margin-zero">
                                                        <input id="form_control_1" type="text" placeholder="Enter Employee Id" class="form-control padding-zero font-bold">
                                                        <label class="control-label margin-zero font-light">Employee id : </label>
                                                    </div>
                                                </div>
                                                <div class="col-md-4 pb-15">
                                                    <div class="form-group form-md-line-input margin-zero">
                                                        <input id="form_control_1" type="text" placeholder="Enter Employee Name" class="form-control padding-zero font-bold">
                                                        <label class="control-label margin-zero font-light">Employee Name : </label>
                                                    </div>
                                                </div>
                                                <div class="col-md-4 pb-15">
                                                    <div class="form-group form-md-line-input margin-zero">
                                                        <input id="form_control_1" type="text" placeholder="Enter Designation" class="form-control padding-zero font-bold">
                                                            <label class="control-label margin-zero font-light">Designation : </label>
                                                            </div>
                                                </div>
                                                ...
                                                <div class="col-md-3 pb-15">
                                                    <div class="form-group form-md-line-input margin-zero">
                                                        ...
                                                        <label class="control-label margin-zero font-light">Gender : </label>
                                                    </div>
                                                </div>
                                                <div class="col-md-3 pb-15">
                                                    <div class="form-group form-md-line-input margin-zero">
                                                        ...
                                                        <label class="control-label margin-zero font-light">Date of Birth : </label>
                                                    </div>
                                                </div>
                                                <div class="col-md-3 pb-15">
                                                    <div class="form-group form-md-line-input margin-zero">
                                                        <input type="text" placeholder="(dd/mm/yyyy)" data-date-format="dd-mm-yyyy" class="form-control form-control-inline date-picker padding-zero font-bold" size="16">
                                                        <label class="control-label margin-zero font-light">Hire Date : </label>
                                                    </div>
                                                </div>
                                                <div class="col-md-3 pb-15">
                                                    <div class="form-group form-md-line-input margin-zero">
                                                        <input type="text" placeholder="(dd/mm/yyyy)" data-date-format="dd-mm-yyyy" class="form-control form-control-inline date-picker padding-zero font-bold" size="16">
                                                        <label class="control-label margin-zero font-light">Release Date : </label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="portlet-title pt-15" style="border-bottom: 0px;margin-bottom: 0px;">
                            <div class="caption caption-md">
                                <i class="icon-globe theme-font hide"></i>
                                <span class="caption-subject bold compheading">Address Info : </span>
                            </div>
                        </div>
                        <div class="portlet-body">
                            <div class="tab-content">
                                    ...
                                    <form role="form" action="#">
                                        <div class="row">
                                            <div class="col-md-12 pb-15">
                                                <div class="form-group form-md-line-input margin-zero">
                                                    <input type="text" placeholder="Enter Address" class="form-control padding-zero font-bold">
                        ...
                        <div class="portlet-title pt-15" style="border-bottom: 0px;margin-bottom: 0px;">
                            <div class="caption caption-md">
                                <i class="icon-globe theme-font hide"></i>
                                <span class="caption-subject bold compheading">KYC Detail : </span>
                            </div>
                        </div>
                        <div class="portlet-body">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="tab_1_1">
                                    <form role="form" action="#">
                                        <div class="row">
                                            <div class="col-md-5 pb-15">
                                                <div class="form-group form-md-line-input margin-zero">
                                                    <select class="form-control font-bold" id="form_control_1">
                                                        <option value="1" selected="">Select Document</option>
                                                        <option value="2">PAN Card</option>
                                                        <option value="3">Aadhar Crad</option>
                                                        <option value="4">Driving Licence</option>
                                                        <option value="5">Voter Id</option>
                                                        <option value="6">Passport</option>
                                                        <option value="7">Other</option>
                                                    </select>
                                                    <label class="control-label margin-zero font-light">Document Type : </label>
                                                </div>
                                            </div>
                                            <div class="col-md-5 pb-15">
                                                <div class="form-group form-md-line-input margin-zero">
                                                    <input type="text" placeholder="Enter Document Number" class="form-control padding-zero font-bold">
                                                    <label class="control-label margin-zero font-light">Document Number : </label>
                                                </div>
                                            </div>
                                            <div class="col-md-2 pb-15">
                                                <div class="form-group form-md-line-input margin-zero">
                                                    <input type="button" value="ADD NEW" class="form-control padding-zero font-bold btn green addaccountcolor">
                                                </div>
                                            </div>
                                        </div>
                                    </form>
